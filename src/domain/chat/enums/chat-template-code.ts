...
export enum ChatTemplateCode {
  ...
  // 광고 작업 챕터
  AUTHOR_AD_CONTE_WORK_START_NOTICE = 'AUTHOR_AD_CONTE_WORK_START_NOTICE', // 광고 콘티 작업 시작 알림 메세지
  AUTHOR_AD_CONTE_WORK_CONFIRM_REQUEST = 'AUTHOR_AD_CONTE_WORK_CONFIRM_REQUEST', // 광고 콘티 작업 컨펌 요청 메세지
